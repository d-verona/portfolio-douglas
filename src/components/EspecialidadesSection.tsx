  ...
  const especialidades = [
    {
      ...
      areas: [
        "Modelagem Geológica 3D com LeapFrog",
        "Sondagens (SPT, Trado, Rotativas)",
        "Análise de Resistência do Solo (NSPT)",
        "Estudos Geotécnicos para Infraestrutura",
    ...
    },
    {
      ...
      areas: [
        "Sistemas de Gestão de Dados Técnicos",
        "WebMaps Interativos e GIS",
        "Aplicações Web Offline para Campo",
    ...
    },
    {
      ...
      areas: [
        ...
        "Processos de Qualidade e Controle",
            ...
            >
              ...
              <CardContent>
                <div className="space-y-3">
                  {especialidade.areas.map((area, areaIndex) => (
                    <div 
                      key={areaIndex}
